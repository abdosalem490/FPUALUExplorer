...
#### Generic variables
#############################################################
set MGC_cpus 4                       ; # ADVANCED: Used for config_app, recommanded to use 16
...
set MGC_maxLengthParam 4e+06a          ; # ADVANCED: Max length which should be targeted for checks and fixing.
...
set MGC_applyShield      false         ; # ADVANCED: Select shielding for advanced technologies or if set to 'true'
...
set MGC_tie_max_fanout 4                   ; # ADVANCED: max_fanout if user wished to over-ride lib limits
...
set MGC_replace_dfm false              ; # ADVANCED : Set to true to enable DFM via replacement
