...
set workdir  "/home/vlsi/mini-project2_nitro" ;        # REQUIRED: Path to project home
...
##########################################################################################################################
set MGC_importVerilogNetlist "${workdir}/verilog/FPU_boothAlgoR4.syn.v"                     ; # REQUIRED: Path to vg netlist.  Multiple files/wildcards allowed, but must 
                                                      #           match vg files only. NOT REQUIRED FOR mxdb flow.
set MGC_topDesign            "FPU_boothAlgoR4"                ; # REQUIRED  : Name of top level module in verilog netlist(s).
